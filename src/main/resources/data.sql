...
INSERT INTO users (username, password, enabled) VALUES
    ('admin#team_20', '{noop}ad_id_20', true),
    ('basic#team_20', '{noop}bs_id_20', true),
    ('pro#team_20', '{noop}pv_id_20', true),
    ('prova#1#team_20', '{noop}pr_id_20', true);
